...
;General
  ...
  ;Name and file
  Name "mklbooster-2.1"
  OutFile "mklbooster-2.1-setup.exe"
...
Section "binaries" SecBinary
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\Uninstall_mklbooster.lnk" "$INSTDIR\Uninstall_mklbooster.exe"
...
Section "sources" SecSources
  ...
  SetOutPath "$INSTDIR\mklbooster\src"
  File /r /x CVS "..\src\*.*"
  SetOutPath "$INSTDIR\mklbooster\vc6"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Uninstall_mklbooster.exe"

  !insertmacro MUI_STARTMENU_GETFOLDER Application $MUI_TEMP
  Delete "$SMPROGRAMS\$MUI_TEMP\build\mklbooster.lnk"
  Delete "$SMPROGRAMS\$MUI_TEMP\Uninstall_mklbooster.lnk"
