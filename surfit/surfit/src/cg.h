...
#ifndef __surfit_solver_cg__
#define __surfit_solver_cg__
...
vec * cg(M * A, V * b, int max_it, REAL tol, vec *& X, REAL undef_value = FLT_MAX) {
	...
	writelog(SURFIT_MESSAGE,"cg: (%d)\terror : %12.6G iter : %d",x->size(), error, iter);
