...
#endif
static int
_wrap_read_globe_func(ClientData clientData, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
    char *arg1 ;
    char *arg2 ;
    bool result;
    
    if (SWIG_GetArgs(interp, objc, objv,"ss:read_globe_func hdr_file bin_file ",&arg1,&arg2) == TCL_ERROR) SWIG_fail;
    {
        try {
            result = (bool)surfit::read_globe_func((char const *)arg1,(char const *)arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "read_globe_func", (swig_wrapper_func) _wrap_read_globe_func, NULL},
    {0, 0, 0}
};
