...
vec * cg_with_acml_threaded(matr * A, const vec * b, int max_it, REAL tol, vec *& X, REAL undef_value) 
{
	...
	writelog(LOG_MESSAGE,"acml_cg: (%d)\terror : %12.6G iter : %d",x->size(), error, iter);
