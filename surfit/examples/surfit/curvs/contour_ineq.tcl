...
cntr_read "cntr_big_circle2.xyz" "cntr_big_circle2"  
 
# load contour from text file 
cntr_read "cntr_big_circle.xyz" "cntr_big_circle"  
 
# load contour from text file 
cntr_read "cntr_center2.xyz" "cntr_center2"  
 
# load contour from text file 
cntr_read "cntr_center.xyz" "cntr_center"  
 
# load contour from text file 
cntr_read "cntr_small_circle2.xyz" "cntr_small_circle2"  
