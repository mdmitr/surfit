...
#ifndef __surfit_globe_ie__included__
#define __surfit_globe_ie__included__
...
#      define GLOBE_EXPORT extern
#      define SURFIT_IO_EXPORT
#    else
#      define SSTUFF_EXPORT __declspec(dllimport)
#      define SURFIT_EXPORT __declspec(dllimport)
#      define GLOBE_EXPORT __declspec(dllimport)
#      define SURFIT_IO_EXPORT __declspec(dllexport)
#    endif
#  endif
#else
