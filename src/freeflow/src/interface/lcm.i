...
surfit::vec * surf_debit(REAL x, REAL y, REAL perm, REAL visc, REAL mult, const char * surface_name="*");
surfit::vec * surf_debit_rect(REAL x1, REAL y1, REAL x2, REAL y2, REAL perm, REAL visc, REAL mult, const char * surface_name="*");
